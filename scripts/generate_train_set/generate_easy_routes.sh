...
ROUNDABOUT_PATH="train_files/roundabout/easy"
INTERSECTION_PATH="train_files/intersection/easy"
...
convert_single_osm() {
    ...
    $SUMO_HOME/tools/randomTrips.py -n "$MYPATH/outputs/${BASE_NAME}_dict/${BASE_NAME}/${BASE_NAME}.net.xml" -p 3.6 -o "$MYPATH/outputs/${BASE_NAME}_dict/${BASE_NAME}/${BASE_NAME}.trips.xml" --fringe-factor max --validate

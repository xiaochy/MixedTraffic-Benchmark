...
ROUNDABOUT_PATH="test_files/roundabout/400"
INTERSECTION_PATH="test_files/intersection/400"
...
convert_single_osm() {
    ...
    $SUMO_HOME/tools/randomTrips.py -n "$MYPATH/outputs/${BASE_NAME}_dict/${BASE_NAME}/${BASE_NAME}.net.xml" -p 9.0 -o "$MYPATH/outputs/${BASE_NAME}_dict/${BASE_NAME}/${BASE_NAME}.trips.xml" --fringe-factor max --validate
